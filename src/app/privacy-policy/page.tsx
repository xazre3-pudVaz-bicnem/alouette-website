...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'コンカフェ alouette（あるえっと）のプライバシーポリシーです。お問い合わせフォームでお預かりする個人情報の利用目的、管理方法、第三者提供、アクセス解析の取り扱いについてご説明します。',
  path: '/privacy-policy/',
});
...
const sections: { title: string; body: string[] }[] = [
  ...
  },
  {
    title: '2. 取得する情報',
    body: [
      '当店では、お問い合わせフォームのご利用時に、お問い合わせ種別、お名前、フリガナ、電話番号、メールアドレス、ご来店希望日・希望時間、人数、お問い合わせ内容をお預かりします。',
  ...
  },
  {
    ...
    body: [
      ...
      'お問い合わせフォームの送信内容は、暗号化された通信を用いて送信されます。',
    ],
  },
  {
    title: '6. アクセス解析について',
